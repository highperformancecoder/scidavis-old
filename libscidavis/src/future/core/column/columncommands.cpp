...
: QUndoCommand( parent ), d_col(col), d_src(src), d_col_backup(0), d_src_backup(0), d_col_backup_owner(0), d_src_backup_owner(0), d_src_start(src_start), d_dest_start(dest_start), d_num_rows(num_rows)
{
	setText(QObject::tr("%1: change cell value(s)").arg(col->name()));
}
