...
///////////////////////////////////////////////////////////////////////////
MatrixInsertColumnsCmd::MatrixInsertColumnsCmd(future::Matrix::Private *private_obj, int before,
...
///////////////////////////////////////////////////////////////////////////
MatrixInsertRowsCmd::MatrixInsertRowsCmd(future::Matrix::Private *private_obj, int before,
                                         int count, QUndoCommand *parent)
    : QUndoCommand(parent), d_private_obj(private_obj), d_before(before), d_count(count)
{
...
///////////////////////////////////////////////////////////////////////////
MatrixRemoveColumnsCmd::MatrixRemoveColumnsCmd(future::Matrix::Private *private_obj, int first,
                                               int count, QUndoCommand *parent)
...
///////////////////////////////////////////////////////////////////////////
MatrixRemoveRowsCmd::MatrixRemoveRowsCmd(future::Matrix::Private *private_obj, int first, int count,
                                         QUndoCommand *parent)
    : QUndoCommand(parent), d_private_obj(private_obj), d_first(first), d_count(count)
{
...
///////////////////////////////////////////////////////////////////////////
MatrixClearColumnCmd::MatrixClearColumnCmd(future::Matrix::Private *private_obj, int col,
                                           QUndoCommand *parent)
...
///////////////////////////////////////////////////////////////////////////
MatrixSetCellValueCmd::MatrixSetCellValueCmd(future::Matrix::Private *private_obj, int row, int col,
                                             double value, QUndoCommand *parent)
...
///////////////////////////////////////////////////////////////////////////
MatrixSetCoordinatesCmd::MatrixSetCoordinatesCmd(future::Matrix::Private *private_obj, double x1,
...
///////////////////////////////////////////////////////////////////////////
MatrixSetColumnCellsCmd::MatrixSetColumnCellsCmd(future::Matrix::Private *private_obj, int col,
                                                 int first_row, int last_row,
                                                 const QVector<qreal> &values, QUndoCommand *parent)
    : QUndoCommand(parent),
      d_private_obj(private_obj),
      d_col(col),
...
///////////////////////////////////////////////////////////////////////////
MatrixSetRowCellsCmd::MatrixSetRowCellsCmd(future::Matrix::Private *private_obj, int row,
...
void MatrixTransposeCmd::redo()
{
    ...
    d_private_obj->emitDataChanged(0, 0, d_private_obj->rowCount() - 1,
                                   d_private_obj->columnCount() - 1);
}
...
///////////////////////////////////////////////////////////////////////////
MatrixMirrorHorizontallyCmd::MatrixMirrorHorizontallyCmd(future::Matrix::Private *private_obj,
                                                         QUndoCommand *parent)
    : QUndoCommand(parent), d_private_obj(private_obj)
{
...
void MatrixMirrorHorizontallyCmd::redo()
{
    ...
    for (int i = 0; i < middle; i++) {
        ...
        d_private_obj->setColumnCells(i, 0, rows - 1,
                                      d_private_obj->columnCells(cols - i - 1, 0, rows - 1));
...
///////////////////////////////////////////////////////////////////////////
MatrixMirrorVerticallyCmd::MatrixMirrorVerticallyCmd(future::Matrix::Private *private_obj,
                                                     QUndoCommand *parent)
    : QUndoCommand(parent), d_private_obj(private_obj)
{
...
void MatrixMirrorVerticallyCmd::redo()
{
    ...
    for (int i = 0; i < middle; i++) {
        ...
        d_private_obj->setRowCells(i, 0, cols - 1,
                                   d_private_obj->rowCells(rows - i - 1, 0, cols - 1));
