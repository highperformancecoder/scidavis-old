...
protected:
  ...
  TableItemDelegate * d_delegate=nullptr;
  ...
  TableViewWidget * d_view_widget=nullptr;
  //! Widget that contains the control tabs UI from #ui
  QWidget * d_control_tabs=nullptr;
  //! Button to toogle the visibility of #d_tool_box
  QToolButton * d_hide_button=nullptr;
  QHBoxLayout * d_main_layout=nullptr;
  TableDoubleHeaderView * d_horizontal_header=nullptr;
