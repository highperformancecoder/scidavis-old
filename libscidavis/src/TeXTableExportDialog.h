...
/*
 * The TeXTableExportDialog class is a dialog window which allows users to
 * select the TeX table parameters and file in wich the table data will be
 * exported in the TeX format.
 */ 
class TeXTableExportDialog: public ExtensibleFileDialog
{
    ...
    public:
        ...
        //! Returns the TeX table settings chosen by the user.
        TeXTableSettings tex_TableSettings(void);
  
    private:
        //! tex_settings_Widget is a pointer to the a TeX table settings
        // widget.
        /**
         *  The TeX table settings widget is inserted in the
         *  current layout.
         */ 
