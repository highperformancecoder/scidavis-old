 ...
 *
 * This class can be seen as a user-interface wrapper around MultiPeakFit, providing functionality
 * for visually selecting estimated peak positions and finally executing the fit.
 *
