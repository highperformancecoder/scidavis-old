...
public:
  ...
  SciQwtSymbol::Style minStyle(){return min_style;};
  void setMinStyle(SciQwtSymbol::Style s){min_style = s;};

  SciQwtSymbol::Style maxStyle(){return max_style;};
  void setMaxStyle(SciQwtSymbol::Style s){max_style = s;};

  void setMeanStyle(SciQwtSymbol::Style s){mean_style = s;};
  SciQwtSymbol::Style meanStyle(){return mean_style;};

  void setP99Style(SciQwtSymbol::Style s){p99_style = s;};
  SciQwtSymbol::Style p99Style(){return p99_style;};

  void setP1Style(SciQwtSymbol::Style s){p1_style = s;};
  SciQwtSymbol::Style p1Style(){return p1_style;};
...
private:
  ...
  SciQwtSymbol::Style min_style, max_style, mean_style, p99_style, p1_style;
