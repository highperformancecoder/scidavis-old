...
/**
 * The TeXTableSettingsWidget is a simple widget which provides the
 * possibility to choose TeX table parameters. It can be inserted into 
 * the other widgets (dialogs) layout, for example, in the TeX table
 * export dialog.
 */
