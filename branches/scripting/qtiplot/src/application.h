...
//variables used when user copy/paste markers
    ...
    QAction *actionPlotL, *actionPlotP, *actionPlotLP, *actionPlotVerticalDropLines, *actionPlotSpline, *actionPlotVertSteps, *actionPlotHorSteps, *actionPlotVerticalBars;
