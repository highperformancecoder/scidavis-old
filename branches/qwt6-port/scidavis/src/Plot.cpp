...
int Plot::axesLinewidth() const
{
	...
	for ( int axis = 0; axis < QwtPlot::axisCnt; axis++ )
	{
        ...
        //TODO does this still work with Qwt6?
#endif
	return 0;
}
...
void Plot::print(QPainter *painter, const QRect &plotRect, const QwtPlotPrintFilter &pfilter)
{
	...
	QwtPlot::print(painter, plotRect, pfilter);
        //TODO - probably need a call to drawItems
#endif
	setTitle(t);
}
...
#else
        titleLabel()->setFrameRect(plotLayout()->titleRect());
#endif
...
#else
            axisWidget(axisId)->setFrameRect(plotLayout()->scaleRect(axisId));
#endif
...
#else
    canvas()->setFrameRect(plotLayout()->canvasRect());
#endif
}
