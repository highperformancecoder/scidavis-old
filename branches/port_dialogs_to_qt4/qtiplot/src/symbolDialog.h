...
public slots:
	//! Slot: language changed (reset title)
    virtual void languageChange();
	//! Slot: find and emit char from pressed button
	void getChar(int btnIndex);
	//! Slot: find and emit char from current button ([return] pressed)
	void addCurrentChar();

signals:
	//! Signal: a letter is to be added
