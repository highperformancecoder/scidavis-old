...
layer.setAxisNumericFormat(Graph.Left,3,3)
layer.setAxisNumericFormat(Graph.Bottom,2,1)
layer.setScale(Graph.Bottom,1,1e6,0,5,5,1) #logarithmic
layer.setFrame(2)
layer.setMargin(5)
layer.setBackgroundColor(Qt.yellow)
layer.setCanvasColor(Qt.cyan)
layer.replot()
graph.exportToFile("layer8.png")
