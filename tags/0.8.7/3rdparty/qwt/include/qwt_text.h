...
public:
    ...
    /*!
      ...
      - MathMLText\n
        ...
        to display the text. A MathML text engine is not part of Qwt library
        and needs to be installed as plugin.
      - TeXText\n
        Use a TeX (http://en.wikipedia.org/wiki/TeX) render engine
        to display the text. A TeX text engine is not part of Qwt library
        and needs to be installed as plugin.
      - OtherFormat\n
        The number of text formats can be extended using a plugin system.
        Format >= OtherFormat are not used by Qwt.
